import 'pages/experts_page/style.scss'
            ...
            _util_.makeJsonp(dfsportswap_lottery + 'wap/expertinfo', data).done(function(result) {
                let data = result.data
                    $sec1.html(`<div class="head-img">
                            ...
                            ${qid !== 'dfsphcios' && qid !== 'dfsphcad' ? '<div class="back"></div><a href="//msports.eastday.com/hc/"><div class="i-home"></div></a>' : ''}
                            `)
                ...
                getServerts().done(function(result) {
                    ...
                    _util_.makeJsonAjax(getgzexpert, data).done(function(result2) {
                        ...
                        if (result2.data.length) {
                            $sec1.append(`<div id="attention" class="attention active"></div>`)
                        } else {
                            $sec1.append(`<div id="attention" class="attention "></div>`)
                        }
        ...
        productHtml(result) {
            ...
            result.forEach(function(item, i) {
                ...
                if (item.status === '3') {
                    ...
                    line_4html = `<div class="yb">${item.price}元宝</div>`
                }
