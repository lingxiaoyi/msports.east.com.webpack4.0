    ...
    class EastSport {
        ...
        common() {
            ...
            if (_qid_ === 'qid10601') {
                ...
                /*$wrapper.find('.navs ul').html(`<li>
                    <a href="/data_world_up_duel.html?name=world_cup" target="_parent">
                        <img src="//sports.eastday.com/jscss/v4/msports/img/worldcup/match2.png" alt="">
                        <p>赛程</p>
                    </a>
                </li>
                <li>
                        <a href="/data_world_up_duel.html?name=world_cup&type=score" target="_parent">
                            <img src="//sports.eastday.com/jscss/v4/msports/img/worldcup/jifen2.png" alt="">
                            <p>积分榜</p>
                        </a>
                    </li>
                    <li>
                        <a href="/data_world_up_duel.html?name=world_cup&type=lists" target="_parent">
                            <img src="//sports.eastday.com/jscss/v4/msports/img/worldcup/sheshou2.png" alt="">
                            <p>射手榜</p>
                        </a>
                    </li>
                <!--<li>
                    <a href="/data_world_up_duel.html?name=world_cup&type=score" target="_parent">
                        <img src="//sports.eastday.com/jscss/v4/msports/img/worldcup/data2.png" alt="">
                        <p>数据</p>
                    </a>
                </li>
                <li>
                    <a href="https://msports.eastday.com/jingcai/detail.html?name=worldcup&qid=${_qid_}" target="_parent">
                        <img src="//sports.eastday.com/jscss/v4/msports/img/worldcup/jc2.png" alt="">
                        <p>竞猜</p>
                    </a>
                </li>-->
                <li>
                    <a href="/theme/hour24.html?name=worldcup&qid=${_qid_}" target="_parent">
                        <img src="//sports.eastday.com/jscss/v4/msports/img/worldcup/hot2.png" alt="">
                        <p>24小时追踪</p>
                    </a>
                </li>`)*/
            } else {
                /*if (_qid_ !== 'qid10479') {
                    ...
                    <li>
                        <a href="http://msports.eastday.com/hc/" target="_parent">
                            <img src="//sports.eastday.com/jscss/v4/msports/img/worldcup/hc2.png" alt="">
                            <p>红彩达人</p>
                        </a>
                    </li>
                    <li>
            ...
            $('.separate-line').remove()
            /*(function() {
                $('.all-football-rank .Android_Slider_Fix').html(`<li>
                    <a href="/data.html?name=els&id=10000051" class="rank-a" target="_parent">
                        <img class="rank-img" src="//sports.eastday.com/jscss/v4/img/world_cup_2018/team/A_1.png" alt="">
                        <p class="rank-txt">俄罗斯</p>
                    </a>
                </li>
                <li>
                    <a href="/data.html?name=xby&id=10000080" class="rank-a" target="_parent">
                        <img class="rank-img" src="//sports.eastday.com/jscss/v4/img/world_cup_2018/team/B_2.png" alt="">
                        <p class="rank-txt">西班牙</p>
                    </a>
                </li>
                <li>
                    <a href="/data.html?name=bx&id=10000083" class="rank-a" target="_parent">
                        <img class="rank-img" src="//sports.eastday.com/jscss/v4/img/world_cup_2018/team/E_1.png" alt="">
                        <p class="rank-txt">巴西</p>
                    </a>
                </li>
                <li>
                    <a href="/data.html?name=agt&id=10004387" class="rank-a" target="_parent">
                        <img class="rank-img" src="//sports.eastday.com/jscss/v4/img/world_cup_2018/team/D_1.png" alt="">
                        <p class="rank-txt">阿根廷</p>
                    </a>
                </li>
                <li>
                    <a href="/data.html?name=fg&id=10000076" class="rank-a" target="_parent">
                        <img class="rank-img" src="//sports.eastday.com/jscss/v4/img/world_cup_2018/team/C_1.png" alt="">
                        <p class="rank-txt">法国</p>
                    </a>
                </li>
                <li>
                    <a href="/data.html?name=wlg&id=10004390" class="rank-a" target="_parent">
                        <img class="rank-img" src="//sports.eastday.com/jscss/v4/img/world_cup_2018/team/A_4.png" alt="">
                        <p class="rank-txt">乌拉圭</p>
                    </a>
                </li>
                <li>
                    <a href="/data.html?name=pty&id=10003565" class="rank-a" target="_parent">
                        <img class="rank-img" src="//sports.eastday.com/jscss/v4/img/world_cup_2018/team/B_1.png" alt="">
                        <p class="rank-txt">葡萄牙</p>
                    </a>
                </li>
                <li>
                    <a href="/data.html?name=dm&id=10003673" class="rank-a" target="_parent">
                        <img class="rank-img" src="//sports.eastday.com/jscss/v4/img/world_cup_2018/team/C_4.png" alt="">
                        <p class="rank-txt">丹麦</p>
                    </a>
                </li>
                <li>
                    <a href="/data.html?name=kldy&id=10003575" class="rank-a" target="_parent">
                        <img class="rank-img" src="//sports.eastday.com/jscss/v4/img/world_cup_2018/team/D_3.png" alt="">
                        <p class="rank-txt">克罗地亚</p>
                    </a>
                </li>
                <li>
                    <a href="/data.html?name=rs&id=10003569" class="rank-a" target="_parent">
                        <img class="rank-img" src="//sports.eastday.com/jscss/v4/img/world_cup_2018/team/E_2.png" alt="">
                        <p class="rank-txt">瑞士</p>
                    </a>
                </li>
                <li>
                    <a href="/data.html?name=mxg&id=10000091" class="rank-a" target="_parent">
                        <img class="rank-img" src="//sports.eastday.com/jscss/v4/img/world_cup_2018/team/F_2.png" alt="">
                        <p class="rank-txt">墨西哥</p>
                    </a>
                </li>
                <li>
                    <a href="/data.html?name=rd&id=10003571" class="rank-a" target="_parent">
                        <img class="rank-img" src="//sports.eastday.com/jscss/v4/img/world_cup_2018/team/F_3.png" alt="">
                        <p class="rank-txt">瑞典</p>
                    </a>
                </li>
                <li>
                    <a href="/data.html?name=bls&id=10003574" class="rank-a" target="_parent">
                        <img class="rank-img" src="//sports.eastday.com/jscss/v4/img/world_cup_2018/team/G_1.png" alt="">
                        <p class="rank-txt">比利时</p>
                    </a>
                </li>
                <li>
                    <a href="/data.html?name=ygl&id=10000075" class="rank-a" target="_parent">
                        <img class="rank-img" src="//sports.eastday.com/jscss/v4/img/world_cup_2018/team/G_4.png" alt="">
                        <p class="rank-txt">英格兰</p>
                    </a>
                </li>
                <li>
                    <a href="/data.html?name=glby&id=10000094" class="rank-a" target="_parent">
                        <img class="rank-img" src="//sports.eastday.com/jscss/v4/img/world_cup_2018/team/H_3.png" alt="">
                        <p class="rank-txt">哥伦比亚</p>
                    </a>
                </li>
                <li>
                    <a href="/data.html?name=rb&id=10004693" class="rank-a" target="_parent">
                        <img class="rank-img" src="//sports.eastday.com/jscss/v4/img/world_cup_2018/jap.png" alt="">
                        <p class="rank-txt">日本</p>
                    </a>
                </li>`)
            })()*/
        }
        ...
        matchRender(arr) {
            ...
            $.each(arr, (i, item) => {
                ...
                html += `<li class="clearfix ${className}">
                        <a href="${`${item.liveurl}?${`qid=${_qid_}&idx=${i + 1}&from=match${i}&pgtype=shijiebei`}`}" suffix="match${i}" target="_parent">
                        <h3>${title}</h3>
                        <div class="team">
            ...
            html += `<li class="clearfix all">
                        <a href="/data_world_up_duel.html?name=world_cup" suffix="shijiebei" target="_parent">
                            点击查看
                            <br> 全部赛程
                        </a>
                    </li>`
        ...
        renderHtml(data) {
            ...
            if (data.show_big / 1 == 1) {
                ...
                secNewsList.append(`<li class="clearfix big-img" style="${data.head.title ? `` : 'margin-top:5px;'}">
                            <a href="${url}?qid=${_qid_}&idx=0&pgnum=1&from=shijiebei&dataType=shijiebei&typeName=${encodeURI('世界杯')}" target="blank" suffix="shijiebei">
            ...
            /*if (data.bottom.url) {
                secNewsList.append(`<a href="${data.bottom.url.replace('http://sports.eastday.com', '//msports.eastday.com')}" class="look-more-news" target="_parent" suffix="shijiebei">
                        点击查看更多世界杯消息  >> 
                    </a>`)
            }*/
        ...
        newsReader(flage, isDown) {
            ...
            self.requestnews(self.startkey, self.pgnum).done((res) => {
                ...
                if (!res.data.length) {
                    news.html('<li class="noData">暂无数据 ^ . ^</li>')
                }
                if (flage === true) {
                ...
                res.data.forEach((a, b) => {
                    if (a.minimg > 2 && a.newstype === 'news') {
                        resBox.append(`<li class="clearfix">
                            <a href="${a.url}?qid=${_qid_}&ishot=${a.ishot}&recommendtype=${a.recommendtype}&idx=${this.newsnum}&pgnum=${this.pgnum}&from=shijiebei&dataType=shijiebei&typeName=${encodeURI('世界杯')}" target="blank" suffix="shijiebei">
