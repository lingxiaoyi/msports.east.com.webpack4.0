...
$(() => {
    ...
    let appStore = 'http://a.app.qq.com/o/simple.jsp?pkgname=com.songheng.eastnews&ckey=CK1370365014873'
    ...
    const pageLogic = {
        ...
        get_share_message: function() {
            ...
            hcCommon.getServerts().done(function (ts) {
                data.ts = ts
                data = signCode(data)
                _util_.makeJson(config.API_URL.JCAPI.get_share_message, data).done(pageLogic.initInfo)
            })
        }
    }
