...
moduleExports.configModule = path.resolve(moduleExports.publicDir, './config/common.config.js') // 存放各种配置文件
...
// 生成文件目录
moduleExports.buildOnline = path.resolve(moduleExports.staticRootDir, '../../sports.eastday.com/tpl/src/msports') //东方体育线上目录
